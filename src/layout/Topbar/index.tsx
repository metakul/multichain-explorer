                ...
                <NavigationMenu.Item>
                    ...
                    <NavigationMenu.Content className="NavigationMenuContent">
                        <ul className="List one">
                            ...
                            <ListItem onClick={() => navigate(Pages.SINGLE_CONTRACT)} title="Contracts">
