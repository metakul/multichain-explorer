    ...
    >
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Box component="nav" sx={{ display: 'flex', flexDirection: 'column' }}>
            <FooterLink onClick={() => navigateTo(PROJECTS.CONTRACTS_HOME)}>APIS</FooterLink>
            <FooterLink onClick={() => navigateTo(Pages.HOME)}>Terms of Service</FooterLink>
              <FooterLink onClick={() => navigateTo(Pages.HOME)}>Disclaimer</FooterLink>
              <FooterLink onClick={() => navigateTo(Pages.HOME)}>Contact Us</FooterLink>
            </Box>
          </Grid>
        </Grid>
        ...
        <Box sx={{ textAlign: 'center', opacity: 0.7 }}>
          <Typography variant="body2">
            &copy; {currentYear} VIA METAKUL. All rights reserved.
          </Typography>
          <Typography variant="caption" display="block" sx={{ mt: 1 }}>
            Metakul is a community-driven project. Rediscover education designed to unlock the true potential of every web user.
          </Typography>
        </Box>
    </Box>
  );
